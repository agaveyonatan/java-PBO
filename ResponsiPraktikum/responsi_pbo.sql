...
INSERT INTO `loan` (`id_loan`, `id_member`, `member_name`, `id_book`, `book_title`, `loan_date`) VALUES
(1, '123', 'Agave Y', 'S_123', 'Harry Buntung', '12-08-2020');
...
--
ALTER TABLE `loan`
  MODIFY `id_loan` int(9) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
COMMIT;
